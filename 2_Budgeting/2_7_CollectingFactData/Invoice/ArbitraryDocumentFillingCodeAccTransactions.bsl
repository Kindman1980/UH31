...
|	И ХозрасчетныйОборотыДтКт.Регистратор ССЫЛКА Документ.ПоступлениеТоваровУслуг
|;
|
|////////////////////////////////////////////////////////////////////////////////
|ВЫБРАТЬ
...
|	ВТ_ПроводкиДокумента.ВалютнаяСумма КАК ВалютнаяСумма,
|	ВТ_ПроводкиДокумента.Валюта КАК Валюта
...
|	ВТ_ПроводкиСТипамиСубконто.ВалютнаяСумма КАК ВалютнаяСумма,
|	ВТ_ПроводкиСТипамиСубконто.Валюта КАК Валюта
|ИЗ
...
|	И ВТ_ПроводкиСТипамиСубконто.СчетЗатрат.Код В ("08.04.1", "26", "44.01", "44.02", "91.02")
|
|ОБЪЕДИНИТЬ ВСЕ
|
|ВЫБРАТЬ
